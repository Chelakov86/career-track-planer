        ...
        >
            ...
            {job.link ? (
                <a
                    ...
                    className="font-bold text-slate-900 dark:text-white mb-1 text-sm truncate hover:text-primary dark:hover:text-primary transition-colors block focus-visible:ring-2 focus-visible:ring-primary focus-visible:outline-none rounded"
                    draggable={false}
                    onClick={(e) => {
                        e.stopPropagation();
                        e.preventDefault();
            ...
            {!isGhost && onView && (
                <button
                    ...
                    className="w-full py-2 bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300 rounded-lg text-sm font-medium hover:bg-primary hover:text-white transition-all mb-3 focus-visible:ring-2 focus-visible:ring-primary focus-visible:outline-none"
                >
                    {t.board.viewDetails}
                </button>
            )}
