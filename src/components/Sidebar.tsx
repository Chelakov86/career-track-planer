...
export const Sidebar: React.FC<SidebarProps> = ({
    ...
    return (
        <aside className={`
      fixed inset-y-0 left-0 z-[30] w-64 bg-white dark:bg-slate-900 border-r border-gray-200 dark:border-slate-800 transform transition-transform duration-300 ease-in-out md:translate-x-0 md:static md:h-screen flex flex-col
    ...
    `}>
            ...
            <nav className="p-4 space-y-2 flex-1">
                <NavLink
                    ...
                    className={({ isActive }) => `flex items-center gap-3 w-full px-4 py-3 text-sm font-medium rounded-lg transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/40 ${isActive
            ...
            <div className="p-4 space-y-4 border-t border-gray-100 dark:border-slate-800 bg-gray-50 dark:bg-slate-900/50">
                ...
                <div className="flex items-center gap-3 p-2 rounded-lg bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-700 shadow-sm">
                    ...
                    <button onClick={logout} aria-label={t.nav.logout} className="text-gray-400 hover:text-red-500 transition-colors p-2 -m-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/50" title={t.nav.logout}>
