        ...
        <div className="fixed inset-0 bg-black/20 dark:bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4 animate-fadeIn">
            <div className="bg-white dark:bg-slate-800 rounded-lg shadow-xl border border-gray-200 dark:border-slate-800 w-full max-w-lg overflow-hidden flex flex-col max-h-[90vh]">
                <div className="p-4 border-b border-gray-200 dark:border-slate-800 flex justify-between items-center">
                    ...
                    <button onClick={onCancel} className="text-gray-400 hover:text-gray-600 dark:hover:text-gray-200 p-1 rounded focus-visible:ring-2 focus-visible:ring-primary focus-visible:outline-none" aria-label={t.board.close} title={t.board.close}>
                        <X className="w-5 h-5" />
                    </button>
                </div>
                            ...
                            <>
                                ...
                                <div className="col-span-2">
                                    ...
                                    <div className="flex gap-2">
                                        ...
                                        {formData.link && (
                                            <a href={ensureAbsoluteUrl(formData.link)} target="_blank" rel="noopener noreferrer" className="p-2 bg-gray-100 dark:bg-slate-700 rounded-lg text-gray-600 dark:text-gray-300 hover:text-primary dark:hover:text-primary hover:bg-primary/10 dark:hover:bg-primary/20 border border-gray-200 dark:border-slate-600 focus-visible:ring-2 focus-visible:ring-primary focus-visible:outline-none" aria-label={t.board.openLink} title={t.board.openLink}>
