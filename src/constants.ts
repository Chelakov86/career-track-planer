...
export const TRANSLATIONS = {
  en: {
    ...
    dashboard: {
      ...
      thisWeek: "this week",
      applicationsAddedOverTime: "Applications Added Over Time",
      added: "Added",
      loadingAnalytics: "Loading analytics...",
      analyticsError: "Analytics could not be loaded.",
      noApplicationEvents: "No application events yet",
  ...
  de: {
    ...
    dashboard: {
      ...
      noApplicationEvents: "Noch keine Bewerbungsereignisse",
