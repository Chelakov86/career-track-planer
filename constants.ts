...
export const STATUS_COLORS: Record<ApplicationStatus, string> = {
  [ApplicationStatus.RESEARCH]: 'bg-gray-100 text-gray-700 border-gray-200',
  [ApplicationStatus.TO_APPLY]: 'bg-blue-50 text-blue-700 border-blue-200',
  [ApplicationStatus.APPLIED]: 'bg-yellow-50 text-yellow-700 border-yellow-200',
  [ApplicationStatus.INTERVIEW]: 'bg-purple-50 text-purple-700 border-purple-200',
  [ApplicationStatus.OFFER]: 'bg-green-50 text-green-700 border-green-200',
